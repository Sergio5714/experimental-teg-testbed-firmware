...
void boardInitAll()
{
	...
	timSettings.TIM_Prescaler = TEMP_MEASUREMENTS_TIM_PSC;
	timInitBase(TEMP_MEASUREMENTS_TIM_MODULE, &timSettings);
	
	// Update interrupt enable
	timInterruptEnable(TEMP_MEASUREMENTS_TIM_MODULE, TIM_DIER_UIE);
